...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aiobotocore-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aiobotocore-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aiobotocore
# for installing globally
pixi global install aiobotocore
```
...
It is possible to list all of the versions of `aiobotocore` available on your platform:
...
```
pixi search aiobotocore --channel conda-forge
```
